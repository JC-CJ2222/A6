...
/*
 * NetId(s): jc3448, yz548
 * Time spent: 4 hours, 00 minutes
 * What I thought about this assignment: We thought that this was a fun assignment that helped us grasp a better understanding of GUI.
 *
 */
...
public class GameMain {
    ...
    private static void createAndShowGUI() {
        ...
        game.addPropertyChangeListener("GameScore",
            (PropertyChangeEvent e) -> scoreLabel.setText("Score: " + game.getScore()));
        ...
        sizeSlider.addChangeListener(
            (ChangeListener) -> game.setTargetRadius(sizeSlider.getValue()));
        ...
        speedSlider.addChangeListener(
            (ChangeListener) -> game.setTargetTimeMillis(speedSlider.getValue()));
    ...
    private static void saveScore(JFrame frame, int score) {
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            try (PrintWriter out= new PrintWriter(
                new BufferedWriter(new FileWriter(fc.getSelectedFile(), true)))) {
                out.println(score);
            } catch (IOException e) {
